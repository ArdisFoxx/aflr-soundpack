# Auto-deploy setup for AFLR Soundpack
...
with id `aflr-soundpack`. This template uses `aflr-soundpack`. Use whatever
id the pack actually ships under so AFLR's voice engine can find it.
